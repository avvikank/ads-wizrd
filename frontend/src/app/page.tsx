...
export default function Home() {
    ...
    const startExtraction = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.post('http://localhost:8000/api/extract-context', { url, country });
    ...
    const refineContext = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.post('http://localhost:8000/api/refine-context', {
                context,
    ...
    const performSearch = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:8000/api/search-ads', {
    ...
    const generateHooks = async () => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/api/generate-hooks', {
                context,
